const THEORIES = [
  ...
  // ════════════════════════════════════════
  {
    ...
    acronym:"기-병-환 (기둥 세우려면 병원체랑 환경이 다 필요해요)",
    mnemonic:"곰팡이 아저씨가 70%로 제일 많이 오고, 세균·바이러스는 사이좋게 10%씩, 선충은 5%만 살짝 껴요!",
  ...
  },
  {
    ...
    acronym:"고-다-수 (고온다습하면 수침상 병반부터 생겨요)",
    mnemonic:"장마철에 물에 폭 젖은 것처럼 반질반질한 수침상 병반이 보이면 역병 의심! 배수만 개선해도 절반은 막아요.",
  ...
  },
  {
    ...
    acronym:"동-분-고 (동그란 과녁에 분홍 물감, 고온다습)",
    mnemonic:"과일에 양궁 과녁처럼 동심원 무늬가 생기고 그 위에 분홍색 물감을 짜놓은 듯하면 탄저병이에요!",
  ...
  },
  {
    ...
    acronym:"흰-잿-노-녹 (흰둥이 잿빛 노균 녹슨 넷이 헷갈려요)",
    mnemonic:"건조하면 흰가루(밀가루 뿌린 듯), 저온다습하면 잿빛(회색 솜털), 서늘다습하면 노균(잎 뒷면 자줏빛), 녹병은 진짜 녹슨 쇠처럼 잎 뒷면이 붉어져요!",
  ...
  },
  {
    ...
    acronym:"도-흰-잎 (도망가다 흰 잎집에 숨었어요)",
    mnemonic:"흰잎마름병만 세균이라 살균제가 안 통해요 - 나머지 둘(도열병·잎집무늬마름병)은 곰팡이라 살균제가 먹혀요!",
  ...
  },
  {
    ...
    acronym:"모-덩-배 (모기가 덩굴에서 배를 채웠어요)",
    mnemonic:"모잘록병은 다리(지제부)가 잘록, 덩굴쪼김병은 줄기가 세로로 쪼개지고, 뿌리혹병은 뿌리에 혹 - 부위가 다 달라요! 뿌리혹병은 산성 토양에서 특히 심해요.",
  ...
  },
  {
    ...
    acronym:"저-흡-천 (저 흡혈귀가 천사처럼 입이 다 달라요)",
    mnemonic:"번데기가 있으면 완전변태(나비), 없으면 불완전변태(매미)! 그리고 응애는 곤충이 아니라 다리 8개 거미라서 살충제 말고 살비제!",
  ...
  },
  {
    ...
    acronym:"진-응-총-온 (진짜 응큼한 총알이 온다)",
    mnemonic:"노란 트랩엔 진딧물·가루이가 몰려들고 파란 트랩엔 총채벌레만 콕 찍혀요 - 노랑은 노랗게, 총채는 파랗게 기억!",
  ...
  },
  {
    ...
    acronym:"배-파-거-이-담 (배 파먹는 거인이 이 담을 넘어요)",
    mnemonic:"거세미나방은 밤에 몰래 나와 땅바닥 줄기를 싹둑 자르는 야행성 자객이에요 - 이름처럼 밑동을 거세게 베어버려요!",
  ...
  },
  {
    ...
    acronym:"벼-애-혹 (벼야 애야 혹시 날아왔니?)",
    mnemonic:"벼멸구는 겨울을 못 나서 매년 중국서 날아오는 나그네, 애멸구는 우리 땅에서 겨울 나는 터줏대감 - 그런데 바이러스는 터줏대감 애멸구가 옮겨요!",
  ...
  },
  {
    ...
    acronym:"화-사-광 (화난 사자가 광합성해요)",
    mnemonic:"사초과만 줄기 단면이 삼각형이라 손으로 만지면 각이 져요 - 화본과·광엽은 둥근데 사초과만 삐죽삐죽!",
  ...
  },
  {
    ...
    acronym:"이-글 접-파 (이글이글 글리포세이트, 접촉하면 파라콰트)",
    mnemonic:"글리포세이트는 뿌리까지 스며들어(이행형) 뽑아도 또 나는 잡초까지 잡고, 파라콰트는 닿은 자리만(접촉형) 태우듯 죽여요!",
  ...
  },
  {
    ...
    acronym:"맹-고-보-저 (맹수가 고보저 마을에 산다)",
    mnemonic:"LD50 숫자가 작을수록 더 위험해요 - 50 이하면 맹독성, 5000 넘으면 저독성. 적은 양으로도 죽으면 독한 거예요!",
  ...
  // ════════════════════════════════════════
  {
    ...
    acronym:"진-즙-총-가-애 (진짜 즙 가진 총든 애들이 바이러스 옮겨요)",
    mnemonic:"TMV만 매개충 없이 손이나 도구의 즙액 접촉으로 옮아요 - 담배 피우던 손으로 만졌다고 담배모자이크병!",
  ...
  },
  {
    ...
    acronym:"무-풋-불 (무풋풋한 불장난)",
    mnemonic:"무름병은 물러지며 악취 나고, 풋마름병은 이름처럼 푸른 채로(풋) 시들고, 불마름병은 불에 그을린 것처럼 갈변돼요 - 이름이 곧 병징!",
  ...
  },
  {
    ...
    acronym:"흰-깨-검-부 (흰 깨가 검게 부었어요)",
    mnemonic:"흰비단병은 흙 위에 하얀 비단실+겨자씨 균핵, 깨씨무늬병은 진짜 참깨 같은 갈색 반점, 검은별무늬병은 사과에 별 모양 상처 - 이름이 곧 그림이에요!",
  ...
  },
  {
    ...
    acronym:"혹-토-살 (혹 파인 토양엔 살선충제)",
    mnemonic:"선충은 눈에 안 보이지만 뿌리에 혹을 남기고 가요 - 혹부리 영감처럼 뿌리에 혹 달고 다니는 게 뿌리혹선충병!",
  ...
  },
  {
    ...
    acronym:"순-심 (순진한 신초, 심각한 과실)",
    mnemonic:"순나방은 이름처럼 새순(신초)을 공격해 끝을 말아버리고, 심식나방은 과실 속(심)까지 파고들어요 - 순은 겉, 심은 속!",
  ...
  },
  {
    ...
    acronym:"경-물-생-화 (경치 좋은 물가에서 생화 꽂기)",
    mnemonic:"화학적 방제는 IPM의 마지막 카드예요 - 저항성 품종(경종), 트랩(물리), 천적(생물)을 다 써보고도 안 되면 그때 약을 쳐요!",
  ...
  },
  {
    ...
    acronym:"경-멀-윤-밀 (경사진 멀리 윤이네 밭에 밀 심었어요)",
    mnemonic:"검은 비닐로 빛을 덮어버리면(멀칭) 잡초는 햇빛을 못 봐서 못 커요 - 광합성 못하면 그냥 굶는 거예요!",
  ...
  },
  {
    ...
    acronym:"동-교-격 (동일 약 반복하면 교체하고 격리)",
    mnemonic:"같은 제초제만 계속 쓰면 잡초도 내성이 생겨요 - 사람이 항생제 내성 생기는 것처럼, 작용 기작 다른 약으로 바꿔줘야 해요!",
  ...
  },
  {
    ...
    acronym:"유-수-액-수 분-입 훈연-훈증 (물에 타서 뿌리다 가루로 톡톡 연기·가스로 훈훈)",
    mnemonic:"물에 녹이거나 타는 애들(유제·수화제·액상수화제·수용제)은 액체로 뿌리고, 분제·입제는 그대로 솔솔, 훈연제·훈증제는 연기나 가스로 퍼져요!",
  ...
  },
  {
    ...
    acronym:"유-카-피-네-스-다 (유카나무 피네, 스타다!)",
    mnemonic:"유기인계랑 카바메이트는 사실 같은 방식(콜린에스테라제 저해)이라 번갈아 써도 효과가 없어요 - 쌍둥이 약을 바꿔치기하는 거나 마찬가지!",
  ...
  },
  {
    ...
    acronym:"보-치-침 (보디가드가 치료하고 침투해요)",
    mnemonic:"보호살균제는 병 걸리기 전에 미리 우산 씌워주는 거고, 치료살균제는 이미 걸린 병을 고쳐줘요 - 우산은 미리, 약은 걸린 후!",
  ...
  },
  {
    ...
    acronym:"축-분-경 (축동되고 분비물 늘고 경련나요)",
    mnemonic:"유기인계에 중독되면 눈동자가 콕 작아지는 축동이 생겨요 - 겁먹은 것처럼 눈이 확 좁아지는 게 첫 신호탄!",
  ...
  },
  {
    ...
    acronym:"살-희-농 (살포액을 희석하면 농약량 나와요)",
    mnemonic:"농약량 = 살포액량 ÷ 희석배수, 나눗셈만 기억하면 끝! 1000L를 1000배로 나누면 딱 1L, 숫자가 예쁘게 떨어져요!",
  ...
  },
  {
    ...
    acronym:"고-유-혼 (고농도 유묘기 혼용사고)",
    mnemonic:"농약을 진하게 타면(고농도) 약해가 나고, 알칼리성이랑 산성을 섞으면 중화돼서 효과가 사라져요 - 콜라에 소다 섞으면 서로 죽여버리는 거랑 같아요!",
  ...
  },
  {
    ...
    acronym:"IRAC-벌레 FRAC-곰팡이 (아이락은 벌레, 프락은 곰팡이 담당)",
    mnemonic:"IRAC은 살충제, FRAC은 살균제 저항성 관리 위원회예요 - 같은 작용 기작 약을 계속 쓰면 해충도 곰팡이도 내성이 생겨서 교호살포가 필수!",
  ...
  // ════════════════════════════════════════
  {
    ...
    acronym:"살-동-무-살선 (살균, 동제, 무치료, 살선충)",
    mnemonic:"곰팡이엔 살균제, 세균엔 동제·항생제, 바이러스엔 치료제가 없어서 매개충만 잡고, 선충엔 살선충제 - 넷 다 처방이 달라요!",
  ...
  },
  {
    ...
    acronym:"벼-배-고-박-과 (벼 배고픈 박과 과수)",
    mnemonic:"작물마다 단골 해충이 있어요 - 벼엔 멸구, 배추엔 좀나방, 고추엔 총채벌레, 과수엔 심식나방. 얼굴만 봐도 어디 사는 애인지 알 수 있어요!",
  ...
  },
  {
    ...
    acronym:"논-밭-저 (논밭에서 저항성 잡초 조심)",
    mnemonic:"논은 이앙 전후 시기별로 약을 나눠 치고, 밭은 멀칭이나 화본과·광엽 전용약으로 구분해서 쳐요 - 논밭이 다르게 싸우는 전략!",
  ...
  },
  {
    ...
    acronym:"등-안-PLS (등록 안 하면 PLS 걸려요)",
    mnemonic:"PLS는 '허용 목록만 인정'하는 제도예요 - 목록에 없으면 무조건 0.01mg/kg, 시험 안 본 사람은 0점 처리하는 것과 같은 원리!",
  ...
  },
  {
    ...
    acronym:"벼-고-토-배 (벼고 토배기 방제 총정리)",
    mnemonic:"흰잎마름병은 세균이라 벼농사에서도 살균제 대신 보르도액을 쓰는 예외 케이스라는 거 잊지 마세요!",
  ...
  },
  {
    ...
    acronym:"품-작-희-독 (품목 작물 희석 독성, 라벨부터 확인!)",
    mnemonic:"피레스로이드계는 벌레도 잘 죽이지만 천적한테도 독해서 무당벌레까지 같이 죽어요 - 아군까지 쏘는 무차별 폭격이에요!",
  ...
  },
  {
    ...
    acronym:"E-A-광광-옥-지 (에이 광광 옥지네)",
    mnemonic:"파라콰트는 빛이 있어야 작용해서 흐린 날 뿌리면 효과가 떨어져요 - 광계를 공격하려면 광합성이 돌아가고 있어야 하거든요!",
  ...
  },
  {
    ...
    acronym:"문-육-상-토-실 (문진하고 육안보고 상세히 토실토실 실험실까지)",
    mnemonic:"의사가 문진부터 시작하듯 식물도 재배 이력 질문(문진)부터 시작해서 마지막엔 실험실 정밀검사까지 - 사람 진료 순서랑 똑같아요!",
  ...
  },
  {
    ...
    acronym:"페-황-청-육 (페로몬 황청육 삼종 트랩)",
    mnemonic:"노란 트랩엔 진딧물·가루이, 파란 트랩엔 총채벌레, 페로몬엔 나방 - 색깔과 향기로 낚시하듯 유인하고, 밀도가 ETL을 넘을 때만 방제해요!",
  ...
  },
  {
    ...
    acronym:"트-바-비 (트리코더마, 바실루스, 비티)",
    mnemonic:"Trichoderma는 흙 속 나쁜 곰팡이를 막아주는 경비원, Bacillus는 잿빛곰팡이·흰가루병 잡는 저격수, Bt는 해충 전용 저격수예요!",
...
THEORIES.push(
  {
    ...
    acronym:"배-윤-건-소-저 (배 윤건이 소저를 만났어요)",
    mnemonic:"토양전염병은 약 한 번 쳐서 안 끝나요 - 배수 손보고, 돌려짓고, 튼튼한 묘 심고, 소독하고, 저항성 품종까지 5단계 풀코스가 필요해요!",
  ...
  },
  {
    ...
    acronym:"트-포-기 (트랩·포장·기상, 예찰 데이터 3종)",
    mnemonic:"트랩에 벌레가 확 늘었다고 바로 약 치면 안 돼요 - 반드시 포장에 나가 실제 밀도를 세어보고 ETL 넘었을 때만 방제하는 게 함정 피하는 법!",
  ...
  },
  {
    ...
    acronym:"원-살-PHI (원제량·살포액·PHI 계산 3종 세트)",
    mnemonic:"마지막 살포 가능일 = 수확예정일 - PHI, 날짜 계산이니까 달력에 거꾸로 세어보면 답이 바로 나와요!",
